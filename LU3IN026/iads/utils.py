...
def create_XOR(n, var):
    ...
    # Définition des centres des 4 gaussiennes et des étiquettes correspondantes
    ...
    for i in range(4):
        desc, lab = genere_dataset_gaussian(centers[i], sigma_matrix, centers[i], sigma_matrix, n)
