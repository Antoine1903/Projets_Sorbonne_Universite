...
function Reply (props) {
    ...
    return (
        <>
            ...
            <div className="message-info">Publié le {formattedDate} par <a
                onClick={() => props.toUserPage(author)}>{author ? author.uname : ""}</a>
            </div>
            <div className="reply-icons">
                ...
                <div className="reply-icon">
                    <button type="button" className="btn-icon-reply" onClick={() => {props.removeReply(props.replyInfo.rid)}}>
